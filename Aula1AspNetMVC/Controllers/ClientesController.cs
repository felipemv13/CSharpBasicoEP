...
namespace Aula1AspNetMVC.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ActionResult Teste()
        {
            ...
            // usando a convenção coloco 'Id'
            ViewBag.Id = new SelectList(db.Cliente.ToList(), "Id", "Nome"); // poderia colocar depois do "Nome", uma ',' e escrever p.ex. 4, ou seja "Nome",4 => que seria o id padrão a ser selecionado no carregamento
